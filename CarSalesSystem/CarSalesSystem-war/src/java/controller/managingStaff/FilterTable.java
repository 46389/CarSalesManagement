...
public class FilterTable extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(!input.isEmpty()){
                session.setAttribute("filter_users", input);
            }else{
                if(session.getAttribute("filter_users") != null){
                    session.removeAttribute("filter_users");
                }
            }         
            switch(account_type) {
            ...
            System.out.println("Error in filtering table: " + e);
        }
    }
