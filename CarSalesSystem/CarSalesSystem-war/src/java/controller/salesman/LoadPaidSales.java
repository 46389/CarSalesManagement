 ...
 * @author Chew Jin Ni
 */
public class LoadPaidSales extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Ticket> paid_saleslist = new ArrayList<>();
            List<Object[]> fetchLists = SalesFacade.findBySalesmanAndCarStatus(salesman_id, CarStock.StockStatus.Paid, SalesStatus.Cancelled);
            ...
            response.sendRedirect("salesman/paid_sales.jsp");
        }
    }
